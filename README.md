...
if we use a visualizer from o-reo's github for example (see the link in Resources), we will first go to the visualizer git.
...
For this project I mainly used 42 peer learning and used AI for the main instructions to code so I could have an idea of where to start and how to agence my project but also for explanations on different concepts. 
Links I used :
- https://github.com/o-reo/push_swap_visualizer
- https://www.geeksforgeeks.org/dsa/radix-sort/
- https://perso.esiee.fr/~courivad/C/rst/12-listes-chainees.html
